...
## In this code, we focus on the NA1 strain of the disease first.
## If all NA1 are treated and resources remain, EU1 will be removed. 

## Budget: 4.1 million dollars per year
...
writeRaster(treatments_2020_stack, "/NA1 Priority Results/4.1 mill 300ft buff/treatments_2020.tif", format="GTiff")
writeRaster(treatments_2021_stack, "/NA1 Priority Results/4.1 mill 300ft buff/treatments_2021.tif", format="GTiff")
writeRaster(treatments_2022_stack, "/NA1 Priority Results/4.1 mill 300ft buff/treatments_2022.tif", format="GTiff")
writeRaster(treatments_2023_stack, "/NA1 Priority Results/4.1 mill 300ft buff/treatments_2023.tif", format="GTiff")
writeRaster(treatments_2024_stack, "/NA1 Priority Results/4.1 mill 300ft buff/treatments_2024.tif", format="GTiff")

writeRaster(EU1_2020_stack, "/NA1 Priority Results/4.1 mill 300ft buff/EU1_2020.tif", format="GTiff")
writeRaster(EU1_2021_stack, "/NA1 Priority Results/4.1 mill 300ft buff/EU1_2021.tif", format="GTiff")
writeRaster(EU1_2022_stack, "/NA1 Priority Results/4.1 mill 300ft buff/EU1_2022.tif", format="GTiff")
writeRaster(EU1_2023_stack, "/NA1 Priority Results/4.1 mill 300ft buff/EU1_2023.tif", format="GTiff")
writeRaster(EU1_2024_stack, "/NA1 Priority Results/4.1 mill 300ft buff/EU1_2024.tif", format="GTiff")

writeRaster(NA1_2020_stack, "/NA1 Priority Results/4.1 mill 300ft buff/NA1_2020.tif", format="GTiff")
writeRaster(NA1_2021_stack, "/NA1 Priority Results/4.1 mill 300ft buff/NA1_2021.tif", format="GTiff")
writeRaster(NA1_2022_stack, "/NA1 Priority Results/4.1 mill 300ft buff/NA1_2022.tif", format="GTiff")
writeRaster(NA1_2023_stack, "/NA1 Priority Results/4.1 mill 300ft buff/NA1_2023.tif", format="GTiff")
writeRaster(NA1_2024_stack, "/NA1 Priority Results/4.1 mill 300ft buff/NA1_2024.tif", format="GTiff")
