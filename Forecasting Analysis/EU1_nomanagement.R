...
## Read in data
infected_file = "/input data/end_inf_2019eu.tif"
...
for (j in 1:length(data2)) {
  infected_stack <- stack()
  for (q in 1:length(data2[[1]]$infected)) {
    infected[] <- data2[[j]]$infected[[q]]
...
writeRaster(probability_before_treat_2020, "/No Management Results/eu_probability_2020.tif", format='GTiff')
writeRaster(probability_before_treat_2021, "/No Management Results/eu_probability_2021.tif", format='GTiff')
writeRaster(probability_before_treat_2022, "/No Management Results/eu_probability_2022.tif", format='GTiff')
writeRaster(probability_before_treat_2023, "/No Management Results/eu_probability_2023.tif", format='GTiff')
writeRaster(probability_before_treat_2024, "/No Management Results/eu_probability_2024.tif", format='GTiff')

writeRaster(all_2020_inf, "/No Management Results/eu_inf_2020.tif", format='GTiff')
writeRaster(all_2021_inf, "/No Management Results/eu_inf_2021.tif", format='GTiff')
writeRaster(all_2022_inf, "/No Management Results/eu_inf_2022.tif", format='GTiff')
writeRaster(all_2023_inf, "/No Management Results/eu_inf_2023.tif", format='GTiff')
writeRaster(all_2024_inf, "/No Management Results/eu_inf_2024.tif", format='GTiff')
