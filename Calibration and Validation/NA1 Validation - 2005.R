...
## To validate spore rate and distance parameters for NA1 Sudden Oak Death disease strain in Oregon

## Uses 100m tanoak proportion data processed from LEMMA OSU Group
## Works with PoPS Package
## Uses 2004 infection data, runs for 2005, compares to 2005 actual infections
...
## Read in data
infected_file = "/validation input data/inf_2004_na.tif"
host_file = "/validation input data/tanoak_2001.tif"
total_plants_file = "/validation input data/max_density.tif"
weather_coefficient_file = #"/weather_coef_2002_2005.tif"
  ## NOTE: weather_coef_2002_2005 file too large to attach on github
  ## If you are a member of the Center for Geospatial Analytics, you can access the file here:
    ## https://drive.google.com/drive/u/0/folders/1-dDN47fiFxfb_1ay0mfGcARNEWTni2zy
  ## Otherwise, please reach out to Devon Gaydos at devon.gaydos@usda.gov or to Chris Jones at cmjone25@ncsu.edu to obtain the file
...
actual_inf_2005 = raster("/validation input data/inf_2005_na.tif")
...
weather_coefficient_stack = subset(weather_coefficient_allyears, 157:210)
...
writeRaster(probability_before_treat_2019, "/NA1 Validation - 2005/probability_2005.tif", format='GTiff')

writeRaster(all_2019_inf, "/NA1 Validation - 2005/inf_2005.tif", format='GTiff')
...
to_write_csv_2005 = "/NA1 Validation - 2005/disagreements_2005.csv"
...
disagreement_df_2005 <- data.frame()
...
for (i in 1:nlayers(all_2019_inf)){
  ...
  disagreement_df_2005 <- rbind(disagreement_df_2005, output)
}

write.csv(disagreement_df_2005, to_write_csv_2005)

average_2005_quantity_disagreement = mean(disagreement_df_2005$quantity_disagreement)
print(paste("Average 2005 Quantity Disagreement: ", average_2005_quantity_disagreement))
min_2005_quantity_disagreement = min(disagreement_df_2005$quantity_disagreement)
print(paste("Min 2005 Quantity Disagreement: ", min_2005_quantity_disagreement))
max_2005_quantity_disagreement = max(disagreement_df_2005$quantity_disagreement)
print(paste("Max 2005 quantity disagreement: ", max_2005_quantity_disagreement))
mode_2005_quantity_disagreement = getmode(disagreement_df_2005$quantity_disagreement)
print(paste("Mode 2005 Quantity Disagreement: ", mode_2005_quantity_disagreement))

average_2005_allocation_disagreement = mean(disagreement_df_2005$allocation_disagreement)
print(paste("Average 2005 Allocation Disagreement: ", average_2005_allocation_disagreement))
min_2005_allocation_disagreement = min(disagreement_df_2005$allocation_disagreement)
print(paste("Min 2005 Allocation Disagreement: ", min_2005_allocation_disagreement))
max_2005_allocation_disagreement = max(disagreement_df_2005$allocation_disagreement)
print(paste("Max 2005 Allocation disagreement: ", max_2005_allocation_disagreement))
mode_2005_allocation_disagreement = getmode(disagreement_df_2005$allocation_disagreement)
print(paste("Mode 2005 Allocation Disagreement: ", mode_2005_allocation_disagreement))

average_2005_true_positives = mean(disagreement_df_2005$true_positives)
print(paste("Average 2005 true positives: ", average_2005_true_positives))
min_2005_true_positives = min(disagreement_df_2005$true_positives)
print(paste("Min 2005 true positives: ", min_2005_true_positives))
max_2005_true_positives = max(disagreement_df_2005$true_positives)
print(paste("Max 2005 true positives: ", max_2005_true_positives))
mode_2005_true_positives = getmode(disagreement_df_2005$true_positives)
print(paste("Mode 2005 true positives: ",mode_2005_true_positives))

average_2005_configuration_disagreement = mean(disagreement_df_2005$configuration_disagreement)
print(paste("Average 2005 landscape: ", average_2005_configuration_disagreement))
min_2005_configuration_disagreement = min(disagreement_df_2005$configuration_disagreement)
print(paste("Min 2005 landscape: ", min_2005_configuration_disagreement))
max_2005_configuration_disagreement = max(disagreement_df_2005$configuration_disagreement)
print(paste("Max 2005 landscape: ", max_2005_configuration_disagreement))
mode_2005_configuration_disagreement = getmode(disagreement_df_2005$configuration_disagreement)
print(paste("Mode 2005 landscape: ",mode_2005_configuration_disagreement))
